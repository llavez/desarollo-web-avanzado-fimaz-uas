...
<div class="card">
    <form method="POST">
        <div class="row">
            <div>
               <label>Nombre</label>
               <input type="text" name="nombre" maxlength="15" value="<?= htmlspecialchars($_POST['nombre'] ?? 'Gilberto Sebastian') ?>">
            </div> 
            <div>
               <label>Apellido</label>
               <input type="text" name="apellido" maxlength="10" value="<?= htmlspecialchars($_POST['apellido'] ?? 'Garcia') ?>">
            </div>
            <div>
               <label>Correo</label>
               <input type="text" name="correo" maxlength="50" value="<?= htmlspecialchars($_POST['correo'] ?? 'gibertoseba1041@gmail.com') ?>">
            </div>
        </div>
