...
<div class="card">
    <div class="card-header text-center">
      <span> <i class="fa-solid fa-trophy"></i> Formulario para Registrar Torneos</span>
    </div>
    ...
    <div class="card-body">
        <form action="torneosInsert.php" method="post">
            ...
            <div class="mb-3">
                ...
                <textarea name="txtPatrocinador" id="patrocinador" cols="30" rows="3" class="form-control"></textarea>
            ...
            <div class="row">
                ...
                <div class="col mb-3">
                    ...
                    <input type="password" name="txtContraseña" id="contraseña" class="form-control">
                </div>
            </div>
