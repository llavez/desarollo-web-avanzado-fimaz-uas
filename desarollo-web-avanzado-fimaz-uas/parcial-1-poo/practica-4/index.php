...
try {
    ...
    $usuarios [] = new Alumno("Maria Solorzano", "maria.alumno@uas.edu.mx", "A12345");
    $usuarios [] = new Invitado("Sebastian Garcia", "sebastian.invitado@xempresa.com", "XEmpresa");
...
echo "<tr><th>Nombre</th><th>Correo</th><th>Rol</th><th>Matricula</th><th>Empresa</th></tr>";
